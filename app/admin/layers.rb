...
# i18n-tasks-use t('activerecord.attributes.layer.ph_h2o')
# i18n-tasks-use t('activerecord.attributes.layer.ph_kcl')
...
ActiveAdmin.register Layer do
  ...
  permit_params :identifier, :top, :bottom, :designation, :bulk_density,
    :ca_co3, :coarse_fragments, :ecec, :conductivity, :organic_carbon, :ph_h2o,
    :ph_kcl, :clay, :silt, :sand, :water_retention
